...
def carregar_imagem_pgm(caminho_imagem):
    """Carrega uma imagem PGM (P2 ou P5) a partir do caminho especificado."""
...
class RobertsFilter:
    def __init__(self, path: str):
        """Inicializa o filtro Roberts carregando a imagem do caminho fornecido."""
        self.image = carregar_imagem_pgm(path)  # Carrega a imagem em tons de cinza
        self.filtered_image = None
        self.tk_image = None  # Atributo para manter a imagem em memória

    def apply_filter(self):
        """Aplica o filtro Roberts à imagem e calcula a magnitude do gradiente."""
        ...
        # Calculando a magnitude do gradiente e convertendo para uint8
